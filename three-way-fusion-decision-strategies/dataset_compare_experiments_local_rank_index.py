...
print("opt_method")
print("---------------------------------------------------------------------------------------------------------------")
row = [local_ranking_index.local_ranking_index(our_opt_method_rank_result, waa_method_rank_result),
       local_ranking_index.local_ranking_index(our_opt_method_rank_result, topsis_method_rank_result),
       local_ranking_index.local_ranking_index(our_opt_method_rank_result, promethee_method_rank_result),
       local_ranking_index.local_ranking_index(our_opt_method_rank_result, jia_and_liu_method_rank_result[0]),
       local_ranking_index.local_ranking_index(our_opt_method_rank_result, jia_and_liu_method_rank_result[1]),
       local_ranking_index.local_ranking_index(our_opt_method_rank_result, zhang_tfs_method_rank_result[0]),
       local_ranking_index.local_ranking_index(our_opt_method_rank_result, zhang_tfs_method_rank_result[1]),
       local_ranking_index.local_ranking_index(our_opt_method_rank_result, jiang_tfs_outranking_method_rank_result)]
results.append(row)
print(row)
print("---------------------------------------------------------------------------------------------------------------")
...
print("com_method")
print("---------------------------------------------------------------------------------------------------------------")
row = [local_ranking_index.local_ranking_index(our_com_method_rank_result, waa_method_rank_result),
       local_ranking_index.local_ranking_index(our_com_method_rank_result, topsis_method_rank_result),
       local_ranking_index.local_ranking_index(our_com_method_rank_result, promethee_method_rank_result),
       local_ranking_index.local_ranking_index(our_com_method_rank_result, jia_and_liu_method_rank_result[0]),
       local_ranking_index.local_ranking_index(our_com_method_rank_result, jia_and_liu_method_rank_result[1]),
       local_ranking_index.local_ranking_index(our_com_method_rank_result, zhang_tfs_method_rank_result[0]),
       local_ranking_index.local_ranking_index(our_com_method_rank_result, zhang_tfs_method_rank_result[1]),
       local_ranking_index.local_ranking_index(our_com_method_rank_result, jiang_tfs_outranking_method_rank_result)]
results.append(row)
print(row)
print("---------------------------------------------------------------------------------------------------------------")
...
print("pes_method")
print("---------------------------------------------------------------------------------------------------------------")
row = [local_ranking_index.local_ranking_index(our_pes_method_rank_result, waa_method_rank_result),
       local_ranking_index.local_ranking_index(our_pes_method_rank_result, topsis_method_rank_result),
       local_ranking_index.local_ranking_index(our_pes_method_rank_result, promethee_method_rank_result),
       local_ranking_index.local_ranking_index(our_pes_method_rank_result, jia_and_liu_method_rank_result[0]),
       local_ranking_index.local_ranking_index(our_pes_method_rank_result, jia_and_liu_method_rank_result[1]),
       local_ranking_index.local_ranking_index(our_pes_method_rank_result, zhang_tfs_method_rank_result[0]),
       local_ranking_index.local_ranking_index(our_pes_method_rank_result, zhang_tfs_method_rank_result[1]),
       local_ranking_index.local_ranking_index(our_pes_method_rank_result, jiang_tfs_outranking_method_rank_result)]
results.append(row)
print(row)
print("---------------------------------------------------------------------------------------------------------------")
...
data_normalized = three_way_main_procedure.data_normalize(data, [1 for i in range(0, 5)])
n, m = data_normalized.shape
concepts = np.random.random((10, m))
# print("concepts:\n", concepts)
weight_vector = np.array([1 / m for _ in range(m)])  # 属性权重
...
np.savetxt("results\\dataset_compare_experiments_with_our_methods_local_rank_index_result.csv", results, delimiter=",",
           fmt='%.4f')

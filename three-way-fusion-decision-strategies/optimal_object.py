...
row = [waa_method_rank_result[0],
       ...
       our_opt_method_rank_result[0],
       our_com_method_rank_result[0],
       our_pes_method_rank_result[0]]
results.append(row)
print(row)
print("---------------------------------------------------------------------------------------------------------------")
...
print("---------------------------------------------------------------------------------------------------------------")
row = [inherent_rank_index.inherent_rank_index(data_normalized, waa_method_rank_result),
       ...
       inherent_rank_index.inherent_rank_index(data_normalized, our_opt_method_rank_result),
       inherent_rank_index.inherent_rank_index(data_normalized, our_com_method_rank_result),
       inherent_rank_index.inherent_rank_index(data_normalized, our_pes_method_rank_result)]
results.append(row)
print(row)
print("---------------------------------------------------------------------------------------------------------------")
'''
...
np.savetxt("results\\dataset_compare_experiments_optimal_object_result.csv", results,
           delimiter=",",
           fmt='%d')

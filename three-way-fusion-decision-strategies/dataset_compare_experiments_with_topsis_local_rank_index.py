...
print("---------------------------------------------------------------------------------------------------------------")
row = [local_ranking_index.local_ranking_index(topsis_method_rank_result, waa_method_rank_result),
       local_ranking_index.local_ranking_index(topsis_method_rank_result, promethee_method_rank_result),
       local_ranking_index.local_ranking_index(topsis_method_rank_result, jia_and_liu_method_rank_result[0]),
       local_ranking_index.local_ranking_index(topsis_method_rank_result, jia_and_liu_method_rank_result[1]),
       local_ranking_index.local_ranking_index(topsis_method_rank_result, zhang_tfs_method_rank_result[0]),
       local_ranking_index.local_ranking_index(topsis_method_rank_result, zhang_tfs_method_rank_result[1]),
       local_ranking_index.local_ranking_index(topsis_method_rank_result, jiang_tfs_outranking_method_rank_result),
       local_ranking_index.local_ranking_index(topsis_method_rank_result, our_opt_method_rank_result),
       local_ranking_index.local_ranking_index(topsis_method_rank_result, our_com_method_rank_result),
       local_ranking_index.local_ranking_index(topsis_method_rank_result, our_pes_method_rank_result)]
results.append(row)
print(row)
print("---------------------------------------------------------------------------------------------------------------")
...
np.savetxt("results\\dataset_compare_experiments_with_topsis_local_rank_index_result.csv", results, delimiter=",",
           fmt='%.4f')
